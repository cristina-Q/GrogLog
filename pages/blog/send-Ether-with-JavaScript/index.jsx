...
export const meta = {
  title: 'Send Ether with JavaScript',
  description: 'Send Ether throw JavaScript Console built in Ethereum (Geth client)',
  date: 'Jan 15, 2021',
  readTime: 5,
  imgsrc: '/img/ethereum.png',
  imgalt: 'Send Ether throw JavaScript',
  imgtitle: 'Send Ether throw JavaScript',
};
